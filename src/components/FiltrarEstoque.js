...
export default function FiltrarEstoque(props){
    ...
    function handleChange(event){
        ...
        setFormData(prevFormData => {
            return {
                ...prevFormData,
                [name] : name === 'quantidade' ? checked ? value : '': value 
            }
        })
    }
    ...
    return <form onSubmit={handleSubmit}className="ms-3 me-3 mt-3">
            ...
            <div className="input-group mb-3">
                ...
                <input id ="produto__nome" onChange={handleChange} name="produto__nome" type="text" className="form-control" aria-label="Nome do Produto" aria-describedby="basic-addon1"></input>
             </div>
            <div className="input-group mb-3">
                <div className="input-group-prepend">
                    <span className="input-group-text">Código de Barras do Produto</span>
                </div>
                <input id ="produto__codigo_de_barras" onChange={handleChange} name="produto__codigo_de_barras" type="number" className="form-control" aria-label="Código de Barras" aria-describedby="basic-addon1"></input>
             </div>
             <div className="form-check form-check-inline">
                <input onChange={handleChange} name="quantidade" id="quantidade" className="form-check-input" type="checkbox" value="0"></input>
